...
n_epochs=00
n_rounds=200
dataset="synthetic" # Options: "diabetes", "breast", "synthetic",'mnist'
n_clients=10
...
# # ## no attack
# attack_type="" # TO DO: "MP_noise", "MP_gradient", "DP_flip", "DP_inverted_loss", "DP_inverted_loss_cf"            Options: 'MP_random', "MP_noise", "DP_flip", "DP_random", "MP_gradient", "DP_inverted_loss"
